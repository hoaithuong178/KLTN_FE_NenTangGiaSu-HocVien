...
const StudentProfile = () => {
    ...
    return (
        <>
            <SEO
                title={`${sampleStudent.name} - Hồ sơ học sinh`}
                description={`Hồ sơ học sinh ${sampleStudent.name}. Tìm hiểu thêm về nhu cầu học tập và các bài đăng tìm gia sư.`}
                ogImage={sampleStudent.avatar}
            />

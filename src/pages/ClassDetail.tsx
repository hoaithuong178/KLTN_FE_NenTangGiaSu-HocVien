...
const ClassDetail: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{classDetail.name} - Chi tiết lớp học | TeachMe</title>
                <meta
                    name="description"
                    content={`Chi tiết lớp học ${classDetail.name}. Xem lịch học, bài tập, và tiến độ học tập.`}
                />
                <meta property="og:title" content={`${classDetail.name} - Chi tiết lớp học`} />
                <meta
                                            ...
                                            <div key={negotiation.id} className="border-b pb-4">
                                                ...
                                                <div className="mt-2 space-y-2">
                                                    <p className="flex justify-between">
                                                        ...
                                                        <span>
                                                            {negotiation.originalPrice.toLocaleString('vi-VN')}đ
                                                        </span>
                                                    </p>
                                                    <p className="flex justify-between">
                                                        <span className="text-gray-600">Giá đề xuất:</span>
                                                        <span>
                                                            {negotiation.negotiatedPrice.toLocaleString('vi-VN')}đ
                                                        </span>
                                                    </p>
                                                    <p className="flex justify-between">
                                                        <span className="text-gray-600">Trạng thái:</span>

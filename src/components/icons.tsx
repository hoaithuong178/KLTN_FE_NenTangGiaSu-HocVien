export const TestIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width={200} height={200} viewBox="0 0 24 24">
        <g fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <path strokeLinecap="round" d="m12.5 17.5l5-5m-2 0l2 2m-5 1l2 2M14 14l2 2" />
        </g>
    </svg>
);
...
export const MyClassIcon = ({ className }: { className?: string }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={24}

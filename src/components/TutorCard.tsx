...
const TutorCard: React.FC<TutorCardProps> = ({ name, experience, rating, image }) => {
    return (
        <div className="flex flex-col items-center bg-white shadow-md rounded-2xl p-4 w-64 h-80 border border-gray-200">
            {/* Image */}
